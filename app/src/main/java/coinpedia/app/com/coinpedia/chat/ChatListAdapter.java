package coinpedia.app.com.coinpedia.chat;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (message.getUserType() == UserType.SELF) {
            if (convertView == null) {
                ...
                FontChangeCrawler fontChanger = new FontChangeCrawler(context.getAssets(), Consts.font1,Consts.font2);
                ...
                holder1.botImageView = (ImageView) v.findViewById(R.id.idBot);
            ...
            if(message.getBotIcon() == 1) {
                ...
                holder1.botImageView.setVisibility(View.VISIBLE);
            }else if(message.getBotIcon() == 2){
                holder1.messageTextView.setText(message.getMessageText());
                holder1.timeTextView.setText(SIMPLE_DATE_FORMAT.format(message.getMessageTime()));
                holder1.botImageView.setVisibility(View.GONE);
            }
