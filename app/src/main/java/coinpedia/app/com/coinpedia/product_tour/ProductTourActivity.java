...
import coinpedia.app.com.coinpedia.product_tour.git.ViewHelper;
...
public class ProductTourActivity extends AppCompatActivity {
    ...
    private void endTutorial(){
       // finish();
        Navigatior.getClassInstance().navigateToActivity(ProductTourActivity.this,HomeActivity.class);
