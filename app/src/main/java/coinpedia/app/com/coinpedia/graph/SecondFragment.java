...
public class SecondFragment extends Fragment  implements OnChartGestureListener,
...
// Required empty public constructor
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGraphTwo = inflater.inflate(R.layout.fragment_second, container, false);
        ButterKnife.bind(this, viewGraphTwo);
        return viewGraphTwo;
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mChart = (LineChart) viewGraphTwo.findViewById(R.id.linechart);
        ...
        MyMarkerView mv = new MyMarkerView(viewGraphTwo.getContext(), R.layout.graph_custom_marker);
    ...
    public void parseGraphIOData2()
    {
        //String coinName = new SharedPrefClass(viewGraphOne.getContext()).getCurrentCoin();
        ProgressClass.getProgressInstance().startProgress(viewGraphTwo.getContext());
      //  ProgressClass.getProgressInstance().startTimeProgressbar(viewGraphTwo.getContext());
        ApiInterface apiInterface = ApiClient.getClient("https://www.coincap.io/").create(ApiInterface.class);
        apiInterface.getGraphWeekData(new SharedPrefClass(viewGraphTwo.getContext()).getCurrentCoin()).enqueue(new Callback<GraphModel>() {
            @Override
...
*/
                    ...
                    {
                        ProgressClass.getProgressInstance().stopProgress();
                        new SweetAlertDialog(viewGraphTwo.getContext(), SweetAlertDialog.ERROR_TYPE)
                                .setTitleText("Oops... ")
                                .setContentText("No Data for this coin-"+new SharedPrefClass(viewGraphTwo.getContext()).getCurrentCoin())
                                .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                    @Override
                                    public void onClick(SweetAlertDialog sweetAlertDialog) {
                                        Navigatior.getClassInstance().navigateToActivityContext(viewGraphTwo.getContext(), CoinDetailActivity.class);
                                    }
                                })
                                .show();
