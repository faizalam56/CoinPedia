...
public abstract class BoomButtonBuilder<T> {
    ...
    public int pieceColor(Context context) {
        if (pieceColor == null && pieceColorRes == 0)
            if (unable) return context.getResources().getColor(R.color.float_small_piece);
            else return context.getResources().getColor(R.color.float_small_piece);
        else if (pieceColor == null) return context.getResources().getColor(R.color.float_small_piece);
        else return context.getResources().getColor(R.color.float_small_piece);
    }
    /*public int pieceColor(Context context) {
        if (pieceColor == null && pieceColorRes == 0)
