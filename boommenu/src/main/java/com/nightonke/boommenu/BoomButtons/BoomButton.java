    ...
    protected void initHamButton() {
        ...
        button.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (listener != null) listener.onButtonClick(index, BoomButton.this);
                if (onBMClickListener != null) onBMClickListener.onBoomButtonClick(index);
                //Toast.makeText(context, "Current Position : "+index, Toast.LENGTH_LONG).show();
                if(index == 0)
                {
                    Intent intentGIS = new Intent(android.content.Intent.ACTION_VIEW);
                    intentGIS.setComponent(new ComponentName("coinpedia.app.com.coinpedia",
                            "coinpedia.app.com.coinpedia.ui.HomeActivity"));
                    context.startActivity(intentGIS);
                }
                else if(index == 1)
                {
                    Intent intentGIS = new Intent(android.content.Intent.ACTION_VIEW);
                    intentGIS.setComponent(new ComponentName("coinpedia.app.com.coinpedia",
                            "coinpedia.app.com.coinpedia.ui.NewsActivity"));
                    context.startActivity(intentGIS);
                }
                else if(index == 2)
                {
                    Intent intentGIS = new Intent(android.content.Intent.ACTION_VIEW);
                    intentGIS.setComponent(new ComponentName("coinpedia.app.com.coinpedia",
                            "coinpedia.app.com.coinpedia.ui.CalculatorActivity"));
                    context.startActivity(intentGIS);
                }
                else if(index == 3)
                {
                    Intent intentGIS = new Intent(android.content.Intent.ACTION_VIEW);
                    intentGIS.setComponent(new ComponentName("coinpedia.app.com.coinpedia",
                            "coinpedia.app.com.coinpedia.ui.NotificationsActivity"));
                    context.startActivity(intentGIS);
              //      Toast.makeText(context, "Working on Notification Activity ", Toast.LENGTH_LONG).show();
                }
